...
class EmbeddingStore:
    ...
    Each instance owns an independent collection, even when names are reused.
    """
    ...
    def __init__(
        ...
        try:
            ...
            # Chroma clients share state within a process. Give each store its
            # own collection to match the isolation of the in-memory backend.
